...
mpr_dataset mpr_dataset_new(const char * name, unsigned int num_sig, mpr_sig * sigs)
{
    unsigned int i;
    ...
    data->sigs = malloc(num_sig * sizeof(mpr_sig));
    memcpy(data->sigs, sigs, num_sig * sizeof(mpr_sig));
