...
/*! Remove a data signal from the graph. */
void mpr_graph_remove_data_sig(mpr_graph g, mpr_data_sig sig, mpr_graph_evt evt);

/*! Remove a data map from the graph. */
void mpr_graph_remove_data_map(mpr_graph g, mpr_data_map map, mpr_graph_evt evt);
